 ...
 * @see ContentCryptoRequestWrapper
 * @since 4.1.3
 */
@Slf4j
public class ContentCryptoResponseWrapper extends HttpServletResponseWrapper {
     ...
     */
    public ContentCryptoResponseWrapper(HttpServletResponse response) {
        super(response);
    }
    ...
    private void encryptBody() throws IOException {
        // do 加密
        CipherText cipherText = new CipherText("U2FsdGVkX18fFbYNhghNDR4o74uiS95ZbIs1dqGR50LVvmXavrreAInPfuRIZhVMT3mjzCcPeRa8");
        byte[] bytes = JSON.toJSONString(cipherText).getBytes(StandardCharsets.UTF_8);
        content.reset();
    ...
    private class ResponseServletOutputStream extends ServletOutputStream {
        ...
        // 响应的原文
        private final FastByteArrayOutputStream originContent = new FastByteArrayOutputStream(1024);
        ...
        /**
         * @param
         * @Description: 这里是修改最终响应，但要注意去掉 ContentCryptoInterceptor 中的 responseWrapper.copyBodyToResponse()
         * @return: void
         * @Author: Bobby.Ma
         * @Date: 2021/10/7 4:12
         */
        ...
        public void flush() throws IOException {
            if (!getResponse().isCommitted()) {
                ...
                outputStream.write("加密响应示例".getBytes(StandardCharsets.UTF_8));
                outputStream.flush();
            }
        }*/
    }
